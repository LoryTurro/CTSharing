...
if ($_SESSION['gruppo'] == "utilizzatore")
                ...
                <div class="col-lg-7 col-12">
                    <div class="hero-text">
                        <div class="hero-title-wrap d-flex align-items-center mb-4">
                            ...
                            <h1 class="hero-title ms-3 mb-0">Benvenuto nell'area soci</h1>
                        </div>

                        <h2 class="mb-4">Ecco i veicoli di <?php echo $_SESSION['agenzia'] ?></h2>
                        <p class="mb-4"><a class="custom-btn btn" style="background-color: var(--primary-color);" href="addVeicolo.php">Aggiungi un nuovo veicolo</a></p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-10 col-12 mx-auto">
                    <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                        ...
                        <h2 class="text-white ms-4 mb-0">I tuoi veicoli</h2>
                    </div>

                    <div class="row pt-lg-5">
                        <?php
                        $veicoli = getVeicoliSocio();
                            ...
                            echo '
                                    <div class="col-lg-6 col-12">
                                        <div class="services-thumb" style="height: 500px;">
                                            ...
                                            <a href="modifyVeicolo.php?id='.$veicolo['id'].'" class="custom-btn custom-border-btn btn mt-3">Modifica</a>
